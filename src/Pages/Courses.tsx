  ...
  return (
    <section>
      <header className="mb-[13rem] max-h-[26rem]">
        <HeadingComponent headingText={headingText} url={headingUrl} />
      </header>
      <main className="mb-[13rem] vs:px-5 md:px-0 xl:px-5 container mx-auto">
        {courses.length > 0 ? (
          ...
          <p className="text-center text-color-primary text-[2rem]">There are currently no courses available</p>
        )}
      </main>
    </section>
  );
