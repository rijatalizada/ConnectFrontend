    ...
    <div className="my-5 ">
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <textarea
          ...
          id="reply"
          placeholder="Message"
          className={`h-[120px] sm:h-[185px] resize-none py-3 px-[15px] block w-full !outline-none text-sm shadow-lg border-[#1d84b5] text-[#888] leading-6 font-normal bg-white !border !border-solid `}
          required
        ></textarea>
        <button
          type="submit"
